 ...
 */
public class VentanaBuscarCantanteDisco extends javax.swing.JInternalFrame {
     ...
     */
    public VentanaBuscarCantanteDisco(ControladorCantante controladorCantante) {
        initComponents();
    ...
    private void initComponents() {
        ...
        label1.setText("Disco");

        label2.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        label2.setText("Nombre");

        txtDisco.setFont(new java.awt.Font("Helvetica Neue", 1, 12)); // NOI18N
        txtDisco.setForeground(new java.awt.Color(51, 102, 255));
        txtDisco.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtDisco.setToolTipText("Ingrese la cedula de la nueva persona");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(txtDisco, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        String nombreDisco = txtDisco.getText();
        Cantante cantante = controladorCantante.buscarCantantePorNombreDisco(nombreDisco);
        if (cantante != null) {
            txtNombre.setText(cantante.getNombre());            
        } else {
            JOptionPane.showMessageDialog(this, "El disco " + nombreDisco + " no ha sido encontrado!");
        }

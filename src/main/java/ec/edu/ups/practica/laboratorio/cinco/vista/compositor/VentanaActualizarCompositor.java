...
public class VentanaActualizarCompositor extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Actualizar Compositor", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Helvetica Neue", 1, 14))); // NOI18N
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if(controladorCompositor.actualizarCompositor(codigo, nombre, apellido, edad, nacionalidad, salario, numeroDeComposiciones)){
    ...
    private void cambiarEstadoCampos(boolean estado){
        ...
        this.txtNumeroDeComposiciones.setEnabled(estado);
    }
    
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        int codigo = Integer.valueOf(txtCodigo.getText());
        Compositor compositor = controladorCompositor.buscarCompositorPorCodigo(codigo);
        if (compositor != null) {

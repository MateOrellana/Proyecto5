 ...
 */
package ec.edu.ups.practica.laboratorio.cinco.vista.persona;


import ec.edu.ups.practica.laboratorio.cinco.vista.compositor.*;
 ...
 */
public class VentanaBuscarCompositorCancion extends javax.swing.JInternalFrame {
     ...
     */
    public VentanaBuscarCompositorCancion(ControladorCompositor controladorCompositor) {
        initComponents();
    ...
    private void initComponents() {
        ...
        label1.setText("Canción:");

        label2.setFont(new java.awt.Font("Lucida Grande", 1, 14)); // NOI18N
        label2.setText("Nombre:");

        txtCancion.setFont(new java.awt.Font("Helvetica Neue", 1, 12)); // NOI18N
        txtCancion.setForeground(new java.awt.Color(51, 102, 255));
        txtCancion.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtCancion.setToolTipText("Ingrese la cedula de la nueva persona");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(txtCancion, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        Compositor compositor = controladorCompositor.buscarCompositorPorNombreCancion(nombreCancion);
        if (compositor != null) {
            txtNombre.setText(compositor.getNombre());            
        } else {
            JOptionPane.showMessageDialog(this, "La canción " + nombreCancion + " no ha sido encontrado!");
        }
